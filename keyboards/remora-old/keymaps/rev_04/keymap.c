...
/*** Updates ***
 * removed oneshot shift on right thumb and replaced with esc
 * added permissive hold and chordal hold
 * added ctl to left thumb for easy ctl copy psate etc
 * added layer tap on down from home row keys for number layer
 */
